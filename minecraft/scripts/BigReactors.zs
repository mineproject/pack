...
recipes.addShaped(<BigReactors:BRReactorPart> * 2, [[<ore:plateStainlessSteel>, <ore:ingotGraphite>, <ore:plateStainlessSteel>], [<ore:ingotElectrum>, <ore:plateDenseLead>, <ore:ingotElectrum>], [<ore:plateStainlessSteel>, <ore:ingotGraphite>, <ore:plateStainlessSteel>]]);
...
recipes.addShaped(<BigReactors:BRTurbinePart> * 2, [[<ore:ingotSteel>, <minecraft:quartz>, <ore:ingotSteel>], [<ore:ingotElectrum>, <ore:ingotCyanite>, <ore:ingotElectrum>], [<ore:ingotSteel>, <minecraft:quartz>, <ore:ingotSteel>]]);
...
recipes.addShaped(<BigReactors:BRTurbinePart:1>, [[<BigReactors:BRTurbinePart>, <BuildCraft|Silicon:redstoneChipset:6>, <BigReactors:BRTurbinePart>], [<BuildCraft|Transport:pipeWire>, <ore:oc:case1>, <BuildCraft|Transport:pipeWire>], [<BigReactors:BRTurbinePart>, <BuildCraft|Transport:pipeWire>, <BigReactors:BRTurbinePart>]]);
recipes.addShaped(<BigReactors:BRReactorPart:1>, [[<ore:reactorCasing>, <ore:chipsetComp>, <ore:reactorCasing>], [<BuildCraft|Transport:pipeWire>, <ore:oc:case1>, <BuildCraft|Transport:pipeWire>], [<ore:reactorCasing>, <BuildCraft|Transport:pipeWire>, <ore:reactorCasing>]]);
