...
[<ore:circuitAdvanced>, <ProjRed|Integration:projectred.integration.gate:32>, <ore:circuitAdvanced>],
...
[<ore:plateTungstenSteel>, <ore:stickTungstenSteel>, <ore:plateTungstenSteel>],
...
// --- Receiver Dish
Assembler.addRecipe(<WR-CBE|Core:recieverDish>, <WR-CBE|Core:stoneBowl>, <WR-CBE|Core:wirelessTransceiver>, <liquid:molten.enderium> * 288, 600, 256);

// --- Blaze Receiver Dish
Assembler.addRecipe(<WR-CBE|Core:blazeRecieverDish>, <WR-CBE|Core:stoneBowl>, <WR-CBE|Core:blazeTransceiver>, <liquid:molten.enderium> * 288, 600, 256);

// --- Wireless Transmitter
Assembler.addRecipe(<WR-CBE|Logic:wirelessLogic>, <ProjRed|Core:projectred.core.part> * 3, <WR-CBE|Core:wirelessTransceiver>, <liquid:molten.enderium> * 576, 600, 256);

// --- Wireless Receiver
Assembler.addRecipe(<WR-CBE|Logic:wirelessLogic:1>, <ProjRed|Core:projectred.core.part> * 3, <WR-CBE|Core:recieverDish>, <liquid:molten.enderium> * 576, 600, 256);

// --- Wireless Jammer
Assembler.addRecipe(<WR-CBE|Logic:wirelessLogic:2>, <ProjRed|Core:projectred.core.part> * 3, <WR-CBE|Core:blazeTransceiver>, <liquid:molten.enderium> * 288, 600, 256);
...
// --- REP
Assembler.addRecipe(<WR-CBE|Addons:rep>, <WR-CBE|Core:blazeTransceiver> * 2, <WR-CBE|Core:retherPearl> * 2, <liquid:molten.concrete> * 1440, 600, 1282);
